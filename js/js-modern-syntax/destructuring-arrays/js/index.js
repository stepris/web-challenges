...
// console.log("Name:", name, "Price:", price, "Item:", quantity);
...
const unnestedStudents = [].concat(...nestedStudents);
...
// const unnestedStudentsOrNot = [student1, ...studentsRest1, ...studentsRest2];

// console.log(unnestedStudentsOrNot);
